...
const App = (function () {
    ...
    const itemAddSubmit = function (e) {
        ...
        if (input.name === "" || input.money === "") {
            ...
            showCustomAlert("Item added successfully", "success");
    ...
    const itemDeleteSubmit = function () {
        ...
        showCustomAlert("Item deleted ", "error");
    ...
    const itemUpdateSubmit = function () {
        ...
        showCustomAlert("Item updated", "success");
    ...
    const clearAllSubmit = function () {
        ...
        StorageCtrl.clearItems();
         ...
         showCustomAlert("All items cleared", "info");
